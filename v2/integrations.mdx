---
title: "Integrations"
description: "Connect Salsa as a Service with 50+ restaurant systems, POS platforms, and enterprise tools"
---

# Integrations

Salsa as a Service seamlessly connects with your existing restaurant technology stack. With 50+ pre-built integrations and a flexible API, you can unify your operations and eliminate data silos.

## Integration Categories

<CardGroup cols={3}>
<Card title="Point of Sale (POS)" icon="credit-card" href="#pos-systems">
...
<Card title="IoT & Hardware" icon="microchip" href="#iot-hardware">
...
salsa = SalsaClient(api_key)

salsa.integrations.connect(
    provider='toast',
    credentials={
