...
<Card title="IoT Quality Monitoring" icon="wifi" href="/v2/advanced-usage#iot-sensors">
...
<Card title="Explore Advanced Features" icon="sparkles" href="/v2/advanced-usage">
...
<Card title="View Integrations" icon="puzzle-piece" href="/v2/integrations">
