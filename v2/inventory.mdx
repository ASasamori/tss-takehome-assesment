...
Our inventory management system uses artificial intelligence and IoT sensors to provide intelligent tracking, predictive ordering, and automated waste prevention.
...
<Card title="Automated reordering" icon="flag">
Smart ordering based on usage patterns
</Card>
<Card title="Usage predictions" icon="brain">
Machine learning predicts ingredient needs
</Card>

<Card title="Anomaly detection" icon="bell">
