...
<CardGroup cols={2}>
<Card title="Inventory Management" icon="box" href="#inventory">
Manage salsa ingredients, track stock levels, and monitor freshness.
</Card>

<Card title="Recipe Management" icon="book" href="#recipes">
Create, update, and manage salsa recipes and production workflows.
</Card>

<Card title="Production Tracking" icon="factory" href="#production">
Track salsa production batches, quality metrics, and yield data.
</Card>

<Card title="Analytics & Reporting" icon="chart-line" href="#analytics">
...
<ResponseField name="data[].category" type="string" required>
Category classification (vegetables, spices, etc.)
</ResponseField>

<ResponseField name="data[].current_stock" type="number" required>
Current stock level
</ResponseField>

<ResponseField name="data[].unit" type="string" required>
Unit of measurement (lbs, oz, etc.)
</ResponseField>

<ResponseField name="data[].supplier" type="string">
Supplier name
</ResponseField>

<ResponseField name="data[].last_updated" type="string" required>
ISO 8601 timestamp of last update
</ResponseField>

<ResponseField name="data[].expiry_date" type="string">
ISO 8601 timestamp of expiration date
</ResponseField>
